...
parser = argparse.ArgumentParser('TGN supervised training')
...
# Load TPPR embeddings (top-k reduced)
tppr_embeddings = np.load('data/tppr_topk_values.npy')  # [num_nodes, tppr_dim]
...
for i in range(args.n_runs):
    ...
    tgn = TGN(neighbor_finder=train_ngh_finder, node_features=node_features,
              ...
              tppr_embeddings=tppr_embeddings,
              n_layers=NUM_LAYER,
