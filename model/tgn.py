...
class TGN(torch.nn.Module):
  def __init__(self, neighbor_finder, node_features, edge_features, device, n_layers=2,
    ...
    self.embedding_module = get_embedding_module(module_type=embedding_module_type,
                                                 ...
                                                 new_node_val_data=self.new_node_val_data,
                                                 new_node_test_data=self.new_node_test_data)
  ...
  def compute_temporal_embeddings(self, source_nodes, destination_nodes, negative_nodes, edge_times,
                                  edge_idxs, n_neighbors=20, batch_number=0, data_type='train_data'):
    """
  ...
  def compute_edge_probabilities(self, source_nodes, destination_nodes, negative_nodes, edge_times,
    ...
    source_node_embedding, destination_node_embedding, negative_node_embedding = self.compute_temporal_embeddings(
      source_nodes, destination_nodes, negative_nodes, edge_times, edge_idxs, n_neighbors, batch_number, data_type)
