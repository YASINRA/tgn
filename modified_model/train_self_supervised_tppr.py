...
parser = argparse.ArgumentParser('TGN self-supervised training with TPPR')
...
for i in range(args.n_runs):
  ...
  tgn = TGN_with_TPPR(neighbor_finder=train_ngh_finder, 
                      ...
                      device=device,
                      edge_list=edge_list,  # Add edge list for TPPR
                      n_layers=NUM_LAYER,
                      n_heads=NUM_HEADS, 
                      dropout=DROP_OUT, 
                      ...
                      dyrep=args.dyrep,
                      use_tppr=True,  # Enable TPPR
                      tppr_weight=args.tppr_weight)  # TPPR weight
